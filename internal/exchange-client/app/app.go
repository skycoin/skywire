// Package app wraps the Skywire app client for the exchange-client application,
// mirroring internal/exchange-market/app.
package app
...
// NewClient creates a new exchange-client app client that connects to the visor.
