...
// real Skycoin node + Esplora. Unlike TestSkydexTradeOverDmsg (scripted chain),
...
//	go test -tags livenet -run TestLiveSkydexTrade -v -timeout 40m ./internal/skydex-e2e/
...
func TestLiveSkydexTrade(t *testing.T) {
