...
tmux send-keys -t VisorA -l "./skywire-visor ./integration/proxy/visorA.json --tag VisorA $SYSLOG_OPTS"
tmux send-keys C-m
...
tmux send-keys -t VisorC -l "./skywire-visor ./integration/proxy/visorC.json --tag VisorC $SYSLOG_OPTS"
tmux send-keys C-m
