...
export PK_A=$(jq -r ".node.static_public_key" ./integration/proxy/visorA.json)
...
export PK_C=$(jq -r ".node.static_public_key" ./integration/proxy/visorC.json)
...
alias RUN_A='go run ./cmd/skywire-visor ./integration/messaging/visorA.json --tag NodeA'
alias RUN_B='go run ./cmd/skywire-visor ./integration/intermediary-nodeB.json --tag NodeB'
alias RUN_C='go run ./cmd/skywire-visor ./integration/messaging/visorC.json --tag NodeC'
