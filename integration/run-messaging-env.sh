...
tmux send-keys -t VisorA -l "./skywire-visor ./integration/messaging/visorA.json --tag VisorA $SYSLOG_OPTS"
tmux send-keys C-m
...
tmux send-keys -t VisorC -l "./skywire-visor ./integration/messaging/visorC.json --tag VisorC $SYSLOG_OPTS"
tmux send-keys C-m
