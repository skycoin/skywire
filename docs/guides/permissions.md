...
See [mainnet_rules.md](https://github.com/skycoin/skywire/blob/develop/rewards/mainnet_rules.md) for more details about the system survey and eligibility requirements for rewards.
