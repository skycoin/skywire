...
func collectSkyenvEdits(cmd *cobra.Command) []skyenvEdit {
	...
	addString("VPNROUTERSUBNET", "vpnrouter-subnet", autoconfigVals.VpnRouterSubnet)
	addSoloBool("VPNROUTERWIFI", "vpnrouter-wifi", autoconfigVals.VpnRouterWifi)
	addString("VPNROUTERSSID", "vpnrouter-ssid", autoconfigVals.VpnRouterSSID)
	addString("VPNROUTERPASSPHRASE", "vpnrouter-passphrase", autoconfigVals.VpnRouterPassphrase)
	addString("VPNROUTERBAND", "vpnrouter-band", autoconfigVals.VpnRouterBand)
