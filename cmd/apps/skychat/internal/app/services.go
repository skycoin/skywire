...
func NewServices(cliRepo client.ClientRepository, usrRepo user.UserRepository, chatRepo chat.ChatRepository, notifService notification.Service, ms messenger.Service) Services {
	return Services{
