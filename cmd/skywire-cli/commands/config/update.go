// Package cliconfig cmd/skywire-cli/commands/config/update.go c4-vis-cli
package cliconfig
...
func setDefaults() {
	...
	if isUsr {
		output = visorconfig.HomePath() + "/" + skyenv.ConfigName
		input = visorconfig.HomePath() + "/" + skyenv.ConfigName
	}
