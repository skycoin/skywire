...
//
// The bubbletea machinery of `visor ping mux-bw-tui`, split behind
// !(js && wasm); the command spec stays in mux_bandwidth_tui.go and a js
// twin stubs runMuxBandwidthTUI.
package ping
