...
productbuild --distribution ${installer_build_dir}/Distribution.xml --package-path ${installer_build_dir} "${output}"SkywireInstaller.pkg

cd "${output}"
#gon -log-level=debug -log-json ./config.json
