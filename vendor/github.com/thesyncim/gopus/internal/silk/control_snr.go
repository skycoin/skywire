...
// ControlSNR sets the encoder's target SNR based on the target bitrate.
// This matches libopus silk/control_SNR.c behavior.

// These tables hold SNR values divided by 21 for different target bitrates
// spaced at 400 bps. The first 10 entries (0-4 kbps) are omitted because
// they're all zeros.
var silkTargetRateNB21 = []uint8{
	0, 15, 39, 52, 61, 68,
...
func (e *Encoder) controlSNR(targetRateBps, nbSubfr int) {
	if targetRateBps <= 0 {
		return
	}
