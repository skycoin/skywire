...
func (m *mockClient) SetEntry(ctx context.Context, e *Entry, method string, pk *cipher.PubKey) error {
...
func (m *mockClient) UpdateEntry(ctx context.Context, sk cipher.SecKey, e *Entry, b bool) error {
	e.Sequence++
