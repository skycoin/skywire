// Package dmsg pkg/dmsg/dmsg/server.go c1-net-dmsg
package dmsg
...
// ServeQUIC, quicPeerPK and handleQUICConn (the server-side dmsg-over-QUIC
// listener + handlers) live in quic_native.go (//go:build !tinygo) — they pull
