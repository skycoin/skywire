...
func TestClientAuth(t *testing.T) {
	...
	apiClient, err := NewHTTP(srv.URL, testPubKey, testSecKey, &http.Client{}, nil, log, masterLogger)
...
func TestBind(t *testing.T) {
	...
	c, err := NewHTTP(srv.URL, testPubKey, testSecKey, &http.Client{}, nil, log, masterLogger)
	require.NoError(t, err)
