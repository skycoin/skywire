...
// ProxyStatus provides a mock function with given fields: appName
func (_m *MockProcManager) ProxyStatus(appName string) (proxystatus.Snapshot, bool) {
	...
	var r1 bool
	if rf, ok := ret.Get(0).(func(string) (proxystatus.Snapshot, bool)); ok {
		return rf(appName)
	}
	if rf, ok := ret.Get(0).(func(string) proxystatus.Snapshot); ok {
		r0 = rf(appName)
	} else {
...
// SetProxyStatusFn provides a mock function with given fields: fn
func (_m *MockProcManager) SetProxyStatusFn(fn func(appName string) (proxystatus.Snapshot, bool)) {
	_m.Called(fn)
}
