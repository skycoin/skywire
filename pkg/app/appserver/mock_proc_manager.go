...
// Run provides a mock function with given fields: log, c, args, stdout, stderr
func (_m *MockProcManager) Run(log *logging.Logger, c appcommon.Config, args []string, stdout io.Writer, stderr io.Writer) (appcommon.ProcID, error) {
