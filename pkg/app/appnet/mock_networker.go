...
// Ping provides a mock function with given fields: pk, addr, autoTp
func (_m *MockNetworker) Ping(pk cipher.PubKey, addr Addr, autoTp bool) (net.Conn, error) {
	ret := _m.Called(pk, addr, autoTp)

	var r0 net.Conn
	if rf, ok := ret.Get(0).(func(cipher.PubKey, Addr, bool) net.Conn); ok {
		r0 = rf(pk, addr, autoTp)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(net.Conn)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(cipher.PubKey, Addr, bool) error); ok {
		r1 = rf(pk, addr, autoTp)
	} else {
		r1 = ret.Error(1)
	}
