import { clear, createSymlinks, createTempAssets, exit, npmAuditFix, patchLockfile, printRuntimeDigest, resolveBins, syncLockfile, verify, yarnImport, yarnInstall, yarnLockToPkgLock, } from './stages.js';
...
export const getFlow = (flow = 'patch') => {
    if (flow === 'convert') {
        return convert;
    }
    if (flow === 'patch') {
