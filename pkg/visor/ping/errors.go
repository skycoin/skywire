// Package ping pkg/visor/ping/errors.go
package ping
...
// Errors for services (1xx).
var (
	ErrSetupNodeNotAvailable = registerErr(Error{code: 100, msg: "setup node not available"})
)

// Errors before connection (2xx).
var (
