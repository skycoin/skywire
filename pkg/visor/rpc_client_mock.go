...
// SetHypervisorAuthPersist implements API
func (mc *mockRPCClient) SetHypervisorAuthPersist(_, _ bool) error { return nil }

// IsHypervisorAuthEnabled implements API
func (mc *mockRPCClient) IsHypervisorAuthEnabled() bool { return false }
...
func (*mockRPCClient) SetAppSettings(string, map[string]int64, map[string]string) (AppSettings, error) {
	return AppSettings{}, nil
}

// CutAppTunnel implements API.
func (*mockRPCClient) CutAppTunnel(string, uint16) (uint64, error) { return 0, nil }
...
func (mc *mockRPCClient) GrowMuxFromPool(_ string, _, _ int, _ uint16) (int, error) {
	return 0, nil
}
