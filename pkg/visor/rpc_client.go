...
func (rc *rpcClient) DoCustomSetting(appName string, customSetting map[string]any, port uint16) error {
...
func (mc *mockRPCClient) DoCustomSetting(appName string, customSetting map[string]any, port uint16) error { //nolint:all
	return mc.do(true, func() error {
		for i := range mc.o.Apps {
