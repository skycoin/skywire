// Package visorapi pkg/visor/visorapi/client.go c3-vis-core
package visorapi
...
func (rc *rpcClient) DmsgPtyExec(args DmsgPtyExecArgs) (*pty.CommandExecResult, error) {
	out := new(pty.CommandExecResult)
...
func (rc *rpcClient) GroupAskAgain(id string) (GroupInfo, error) {
	var resp GroupInfo
	err := rc.Call("GroupAskAgain", &id, &resp)
	return resp, err
}
