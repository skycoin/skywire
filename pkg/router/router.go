...
const (
	...
	// 0 means routes persist indefinitely until explicitly closed.
	// Routes are cleaned up when the owning connection closes.
	DefaultRouteKeepAlive = time.Duration(0)
