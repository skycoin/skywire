...
type MockRouter struct {
	mock.Mock
	// muxFEC backs Set/GetMuxFEC without a mock expectation; see SetMuxFEC.
	muxFEC bool
}
...
// SetMuxFEC provides a mock function backed by a plain field: the value
// carries no behaviour worth asserting, and a Called() would panic in every
// existing MockRouter test that reaches the setting.
func (_m *MockRouter) SetMuxFEC(v bool) { _m.muxFEC = v }

// GetMuxFEC provides a mock function; see SetMuxFEC.
func (_m *MockRouter) GetMuxFEC() bool { return _m.muxFEC }
