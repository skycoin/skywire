...
func (_m *MockStore) RecordHeartbeat(ctx context.Context, pk cipher.PubKey, version string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, cipher.PubKey, string) error); ok {
		r0 = rf(ctx, pk, version)
	} else {
		r0 = ret.Error(0)
	}
...
// GetAllVisorSummaries provides a mock function with given fields: ctx, v2, timeline
func (_m *MockStore) GetAllVisorSummaries(ctx context.Context, v2 bool, timeline bool) ([]VisorSummary, error) {
	ret := _m.Called(ctx, v2, timeline)

	var r0 []VisorSummary
	if rf, ok := ret.Get(0).(func(context.Context, bool, bool) []VisorSummary); ok {
		r0 = rf(ctx, v2, timeline)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]VisorSummary)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, bool, bool) error); ok {
		r1 = rf(ctx, v2, timeline)
	} else {
		r1 = ret.Error(1)
	}
...
// GetDailyTimeline provides a mock function with given fields: ctx, pkHex, now
func (_m *MockStore) GetDailyTimeline(ctx context.Context, pkHex string, now time.Time) map[string]string {
	ret := _m.Called(ctx, pkHex, now)

	var r0 map[string]string
	if rf, ok := ret.Get(0).(func(context.Context, string, time.Time) map[string]string); ok {
		r0 = rf(ctx, pkHex, now)
	} else {
		if ret.Get(0) != nil {
