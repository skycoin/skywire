...
import routerclient "github.com/skycoin/skywire/pkg/router/routerclient"
...
// ReserveIDs provides a mock function with given fields:
func (_m *MockIDReserver) ReserveIDs() {
	_m.Called()
}
