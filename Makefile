...
dep-github-release:
	...
	wget -c https://more.musl.cc/10/x86_64-linux-musl/riscv32-linux-musl-cross.tgz -O riscv32-linux-musl-cross.tgz
	tar -xzf riscv32-linux-musl-cross.tgz -C ./musl-data && rm riscv32-linux-musl-cross.tgz
