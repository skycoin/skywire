...
-   feat(skysocks): an upload to a cooperating sink is striped across the tunnels in acked chunks and survives a dead tunnel  [#XXXX](https://github.com/skycoin/skywire/pull/XXXX)
